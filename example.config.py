...
# ldap_url = 'ldap://ldap.domain.lan:389' # AD
# ldap_bind_user = 'admin_vpn'            # AD
...
# ldap_attrlist = {'user_name': 'sAMAccountName', 'user_contact': 'mail'}

# For Freeipa
ldap_url = 'ldap://ldap.domain.lan'
ldap_bind_user = 'uid=system_user_vpn,cn=sysaccounts,cn=etc,dc=sfxdx,dc=lan'
ldap_bind_pass = 'up9oJoXerohtaishoroer2Ijeugir4'
ldap_basedn = 'dc=domain,dc=loc'
ldap_filter = '(&(objectclass=inetorgperson)(memberOf=cn=vpn-users,cn=groups,cn=accounts,dc=domain,dc=lan))'
ldap_attrlist = {
    'user_name': 'uid',
    'user_contact': 'mail'
    }
